...
template.innerHTML = `
  <button class="absolute z-10 top-2 left-2 p-2 rounded-full shadow-md dark:border border-gray-400 bg-gray-100 dark:bg-gray-800">
    <svg class="size-3">
...
export default class FavoriteBox extends HTMLElement {
  constructor(){
    super()
  ...
  connectedCallback(){
    ...
    this.className = `${customClass || 'swiper-slide block w-full 3xs:w-[220px]'} relative product h-max p-[10px] rounded bg-[#ebebeb] dark:bg-[#1d1d22]`
  }
